...
@Component({
  selector: 'app-teacher-shared',
  templateUrl: './teacher-shared.component.html',
  styleUrls: ['./teacher-shared.component.scss']
})
export class TeacherSharedComponent implements OnInit {
